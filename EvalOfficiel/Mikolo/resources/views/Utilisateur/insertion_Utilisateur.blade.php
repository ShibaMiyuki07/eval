            ...
            <div class="page-header">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Insertion d'utilisateur</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Insertion d'utilisateur</h4>
                    <form class="forms-sample" action='{{ route("utilisateur.insert") }}' method='post'>
                      @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name='age' id="exampleInputName1" placeholder="Age...">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">email</label>
                        <input type="email" class="form-control" name='email' id="exampleInputName1" placeholder="Login..">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">mdp</label>
                        <input type="password" class="form-control" name='mdp' id="exampleInputEmail3" placeholder="Mot de passe...">
                      </div>
