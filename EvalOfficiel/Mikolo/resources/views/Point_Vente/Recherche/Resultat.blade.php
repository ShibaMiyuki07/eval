          ...
          <div class="content-wrapper">
            <div class='row'>
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Resultats des recherches</h4>
                    </p>
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>{{ $result->laptop_marque}}</td>
                            <td>{{ $result->caracteristique_ecran }},{{ $result->frequence_ecran }}Hz</td>
                            <td>{{ $result->capacite_disque_dur }}Go, produit par {{ $result->disque_dur_marque }}</td>
                            <td> {{ $result->reference }}</td>
                            <td>{{ $result->qte_restante }}</td>
                            <td>{{ $result->prix_vente }}Ar</td>
                            </form>
                          </tr>
                          @endforeach
                        </tbody>
