                      ...
                      <table class="table table-striped">
                        <thead>
                          <tr>
                            ...
                            <th> Date/Heure de vente </th>
                          </tr>
                        </thead>
                        <tbody>
                          @foreach ($ventes as $vente)
                          <tr>
                            <td>{{ $vente->laptop->marque->marque }}</td>
                            <td>{{ $vente->laptop->processeur->marque->marque }}  {{ $vente->laptop->processeur->caracteristique }}</td>
                            <td>{{ $vente->laptop->reference }}</td>
                            <td>{{ $vente->laptop->disque_dur->capacite }}Go,produit par {{ $vente->laptop->disque_dur->marque->marque }}</td>
                            <td>{{ $vente->laptop->ecran->caracteristique }},{{ $vente->laptop->ecran->frequence }}</td>
                            <td>{{ $vente->laptop->ram->capacite }}Go,{{ $vente->laptop->ram->frequence }}Hz</td>
