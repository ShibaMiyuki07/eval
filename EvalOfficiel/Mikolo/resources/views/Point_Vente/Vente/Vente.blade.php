          ...
          <div class="content-wrapper">
            <div class='row'>
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Liste des laptops a vendre</h4>
                    </p>
                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <form method='post' action='{{ route("vente.insert") }}'>
                            <td>
                                @csrf
                                ...
                                <input type='number' class="form-control" name='qte' placeholder='Quantite vendu..'>
                            </td>
