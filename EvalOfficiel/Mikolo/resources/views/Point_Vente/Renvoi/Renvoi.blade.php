          ...
          <div class="content-wrapper">
            <div class='row'>
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Liste des laptops à renvoyer</h4>
                    </p>
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>{{ $stock->laptop->marque->marque }}</td>
                            ...
                            <form method='post' action='{{ route("stock.renvoi") }}'>
                            <td>
                                @csrf
                                <input type='hidden' name='total' value='{{ $stock->quantite }}'>
                                <input type='hidden' name='idlaptop' value='{{ $stock->idlaptop }}'>
                                <input type='hidden' name='idpv' value='{{ $idPV }}'>
                                <input type='number' class="form-control" name='qte' placeholder='Quantite à renvoyer..'>
                            </td>
