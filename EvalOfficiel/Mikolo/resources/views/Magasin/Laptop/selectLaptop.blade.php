                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td> {{ $laptop->marque->marque }} </td>
                            <td>{{ $laptop->processeur->marque->marque }}{{ $laptop->processeur->caracteristique }}</td>
                            <td>{{ $laptop->ecran->caracteristique }},{{ $laptop->ecran->frequence }}Hz</td>
                            <td>{{ $laptop->disque_dur->capacite }}Go, produit par {{ $laptop->disque_dur->marque->marque }}</td>
                            <td> {{ $laptop->reference }}</td>
                            <td>{{ $laptop->prix_achat }}Ar</td>
                            <form method='post' action='{{ route("stock.insert") }}'>
                            <td>
                                @csrf
                                <input  type='hidden' name='idlaptop' value='{{ $laptop->getKey() }}'>
                                <input type='number' class="form-control" name='qte' placeholder='Quantite..'>
                            </td>
                            <td>
                                <input type='number' class="form-control" name='vente' placeholder='Prix de Vente..'>
                            </td>
