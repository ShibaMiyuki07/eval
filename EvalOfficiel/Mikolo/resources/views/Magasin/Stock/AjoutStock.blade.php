            ...
            <div class="page-header">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Transfert de laptop</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">  
                    ...
                    <h4 class="card-title">Transfert de {{ $stock->laptop->marque->marque }}{{ $stock->laptop->reference }} quantite actuelle {{ $stock->quantite }}</h4>
                        <form class="forms-sample" action='{{ route("pv.insert") }}' method='post'>
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name='qte' id="exampleInputName1" placeholder="Quantite..">
                        </div>
                        <div class="form-group">
                            <select name='pv' class="form-control" style='color:white'>
