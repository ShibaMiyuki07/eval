          ...
          <div class="content-wrapper">
            <div class='row'>
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Liste des laptops</h4>
                    </p>
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><a href='{{ route("stock.laptop",["idlaptop"=>$stock->idlaptop]) }}'> {{ $stock->laptop->marque->marque }} </a></td>
                            <td>{{ $stock->laptop->processeur->marque->marque }}{{ $stock->laptop->processeur->caracteristique }}</td>
                            <td>{{ $stock->laptop->ecran->caracteristique }},{{ $stock->laptop->ecran->frequence }}Hz</td>
                            <td>{{ $stock->laptop->disque_dur->capacite }}Go, produit par {{ $stock->laptop->disque_dur->marque->marque }}</td>
                            <td> {{ $stock->laptop->reference }}</td>
                            <td>{{ $stock->prix_vente }}Ar</td>
                            <td>
                                @if ($stock->quantite>=20)
                                <div class="progress">
                                    <div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="{{ $stock->quantite }}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                @endif
                                @if ($stock->quantite<=10)
                                <div class="progress">
                                    <div class="progress-bar bg-danger" role="progressbar" style="width: 25%" aria-valuenow="{{ $stock->quantite }}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                @endif
                                @if($stock->quantite>10 && $stock->quantite<20)
                                <div class="progress">
                                    <div class="progress-bar bg-warning" role="progressbar" style="width: 25%" aria-valuenow="{{ $stock->quantite }}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                @endif
                            </td>
                          </tr>
