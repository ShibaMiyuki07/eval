                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <form method='post' action='{{ route("magasin.reception") }}'>
                            <td>
                                @csrf
                                <input type='hidden' name='total' value='{{ $transfert->quantite }}'>
                                <input type='hidden' name='idlaptop' value='{{ $transfert->idlaptop }}'>
                                <input type='hidden' name='idpv' value='{{ null }}'>
                                <input  type='hidden' name='idtransfert_point_vente' value='{{ $transfert->idtransfert_point_vente }}'>
